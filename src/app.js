...
function formatMoney(value) {
  return new Intl.NumberFormat(state.settings.locale || "es-AR", {
    style: "currency",
...
function formatNumber(value) {
  return new Intl.NumberFormat(state.settings.locale || "es-AR").format(Number(value || 0));
}

function formatDateTime(iso) {
  return new Intl.DateTimeFormat(state.settings.locale || "es-AR", {
    dateStyle: "medium",
    timeStyle: "short",
